...
(29, 'setlistfm_id', 'TEXT', 0, None, 0)
(30, 'bandcamp_url', 'TEXT', 0, None, 0)
...
(41, 'bandcamp_url', 'TEXT', 0, None, 0)
(42, 'lastfm_url', 'TEXT', 0, None, 0)
...
Estructura de la tabla: places_setlistfm
(0, 'id', 'INTEGER', 0, None, 1)
(1, 'venue_id', 'TEXT', 1, None, 0)
(2, 'venue_name', 'TEXT', 0, None, 0)
(3, 'city_name', 'TEXT', 0, None, 0)
(4, 'city_state', 'TEXT', 0, None, 0)
(5, 'coords', 'TEXT', 0, None, 0)
(6, 'country_name', 'TEXT', 0, None, 0)
(7, 'country_code', 'TEXT', 0, None, 0)
(8, 'artists_num', 'INTEGER', 0, None, 0)
(9, 'conciertos_num', 'INTEGER', 0, None, 0)
(10, 'artists_names', 'TEXT', 0, None, 0)
(11, 'last_updated', 'TIMESTAMP', 0, 'CURRENT_TIMESTAMP', 0)
