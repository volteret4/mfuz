...
"            }}")
        ...
        self.addButton.setMinimumSize(QSize(36, 36))
        self.addButton.setMaximumSize(QSize(36, 36))
        font = QFont()
        ...
        self.delButton.setMinimumSize(QSize(0, 0))
        self.delButton.setMaximumSize(QSize(36, 36))
        ...
        self.delButton.setIconSize(QSize(30, 30))
        ...
        self.rewButton = QPushButton(self.frame)
        self.rewButton.setObjectName(u"rewButton")
        self.rewButton.setMinimumSize(QSize(0, 0))
        self.rewButton.setMaximumSize(QSize(36, 36))
        self.rewButton.setFont(font)
        icon3 = QIcon()
        icon3.addFile(u":/services/b_prev", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.rewButton.setIcon(icon3)
        self.rewButton.setIconSize(QSize(30, 30))

        self.horizontalLayout_3.addWidget(self.rewButton)
        ...
        self.ffButton = QPushButton(self.frame)
        ...
        self.ffButton.setMinimumSize(QSize(36, 36))
        self.ffButton.setMaximumSize(QSize(36, 36))
        self.ffButton.setFont(font)
        self.ffButton.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.ffButton.setStyleSheet(u"QPushButton {{\n"
"	border-radius: 20\n"
"}}")
        icon5 = QIcon()
        icon5.addFile(u":/services/b_ff", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.ffButton.setIcon(icon5)
        self.ffButton.setIconSize(QSize(30, 30))

        self.horizontalLayout_3.addWidget(self.ffButton)
